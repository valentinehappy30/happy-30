...
const allWords = [
    ...
    { id: 14, mot: "FIDÈLE", definition: "6 – 9 – 4 – 5 – 12 – 5", auteur: "Alizée", groupe: "amis", message: "Toi, Val, mon soutien sans faille depuis toutes ces années lors de mes galas de danse. Des fables de la Fontaine à Aladin, tu m’as accompagnée dans ces moments importants liés à ma passion. Et finalement, cela ne se résume pas qu’à des galas de danse puisque notre amitié, datant des bancs de la fac, est passée par des mariages, des ateliers créatifs, des joies, des week-ends, des pleurs, des coups durs, des déménagements, des EVJF. Merci de faire partie de ma vie et de rependre ton émerveillement, ta générosité et ton innocence autour de toi. Merci d’être une amie fidèle. <br>Ps : Je te souhaite le plus beau des anniversaires, entourée de ceux que tu aimes, le K, le mini K, ta famille, tes amis ! Quelle joie de te voir à l’origine de moments festifs, tu rayonnes 🌟" }
];
